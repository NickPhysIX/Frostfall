# Frostfall — Release Notes Through v9.8.3

## Current release: v9.8.3 — Animal Audio Cues
...
The latest release adds one-shot animal and player-death audio cues: wave starts now play a matching howl/growl, rats squeak when they escape with meat, and player death triggers a female scream SFX. The new cues are kept readable with temporary music ducking and respect the existing master mute/background audio rules.
