# Frostfall — Release Notes Through v9.8.2

## Current release: v9.8.2 — Crow Caw Audibility
...
The latest release adds the **Rat Scavenger**: a meat thief that the player cannot kill directly, but wolves can hunt once it has stolen meat.

The latest release refines the rat/wolf interaction so one meat-carrying rat can no longer pull an entire wolf pack away from the camp.

The latest release improves the Crow Thief audio event so the crow-caw is reliably audible when meat is stolen, including early buffer preloading, higher event gain, and temporary music ducking.
