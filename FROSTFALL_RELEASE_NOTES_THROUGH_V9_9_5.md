# Frostfall Release Notes Through v9.9.5

## v9.9.5 — NG+ Upgrade Soft Cap

- NG+-extra capped-upgrade levels are now capped at +10 total.
- Survivor/hunter cap bonuses are now capped at +10 total.
- Scaling remains +2 per NG+ cycle until NG+5; NG+5 and later stay at +10.
- Prevents extreme exponential stat growth in high-cycle NG+.
- Uncapped upgrades remain uncapped.
- Tower-cap scaling remains unchanged and still caps at 50.
- Existing overcap saves are grandfathered.
